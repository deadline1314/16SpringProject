...
public class Screen_CarList extends JFrame implements ActionListener {
	...
	private void createAddComponents(String dealerName, JRadioButton jb) {
		 ...
		 * JTable design
		 */
		JTable table = new JTable(new MyModel(columns, dataFinal));
...
//		for (int i = 0; i < data.size(); i++) {
//			if (dataFinal[i][0] == (JRadioButton) jb)
//				clickedRow = i;
//		}
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == delete) {
			...
			if (confirm == 0) {
				...
				tempDelete = cfm.readCars("/Users/workspace/Final_Project/src/project/vehicle/data/" + dealerName);
		...
		if (ae.getSource() == modify) {
			...
			// Car should be the object which has been selected
			Screen_ModifyRecord motifyScreen = new Screen_ModifyRecord(clickedCar, dealerName, data);
		}
