...
public class Screen_CarList extends JFrame implements ActionListener
{
    ...
    {
        int currentCombo = 0;
        String[] currCombos = new String[6];
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            else if (e.getSource() == fCombo2 && (currentCombo == 0 || currentCombo == 2))
            {
                currentCombo = 2;
                int i = fCombo2.getSelectedIndex();
                String yearSelect = fCombo2.getItemAt(i);
                ...
                recoverCurrent(2);
                currentCombo = 0;
            } else if (e.getSource() == fCombo3 && (currentCombo == 0 || currentCombo == 3))
            {
                currentCombo = 3;
                int i = fCombo3.getSelectedIndex();
                String makeSelect = fCombo3.getItemAt(i);
                ...
                recoverCurrent(3);
                currentCombo = 0;
            } else if (e.getSource() == fCombo4 && (currentCombo == 0 || currentCombo == 4))
            {
                currentCombo = 4;
                int i = fCombo4.getSelectedIndex();
                String modelSelect = fCombo4.getItemAt(i);
                ...
                recoverCurrent(4);
                currentCombo = 0;
            } else if (e.getSource() == fCombo5 && (currentCombo == 0 || currentCombo == 5))
            {
                currentCombo = 5;
                int i = fCombo5.getSelectedIndex();
                String typeSelect = fCombo5.getItemAt(i);
                ...
                recoverCurrent(5);
                currentCombo = 0;
            } else if (e.getSource() == fCombo6 && (currentCombo == 0 || currentCombo == 6))
            {
                currentCombo = 6;
                int i = fCombo6.getSelectedIndex();
                String priceSelect = fCombo6.getItemAt(i);
