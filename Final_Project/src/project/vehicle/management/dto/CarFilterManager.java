...
public class CarFilterManager
{
    ...
    public CarFilterManager(String dealerName)
    {
        ...
        this.originalCarList = cfm
                .readCars("/Users/workspace/Final_Project/src/project/vehicle/data/" + dealerName);
    ...
    public void conditionFilter(String n)
    {
        ...
        // tempCarList ;
        /*
         * for (Car originalCar : originalCarList) { a =
         * originalCar.getCondition().equals(conditionSelected); if
         * (conditionSelected.equals("Select")) a = true;
         * 
         * b = (String.valueOf(originalCar.getYear())).equals(yearSelected); if
         * (yearSelected.equals("Select")) b = true;
         * 
         * c = originalCar.getMake().equals(makeSelected); if
         * (makeSelected.equals("Select")) c = true;
         * 
         * d = originalCar.getModel().equals(modelSelected); if
         * (modelSelected.equals("Select")) d = true;
         * 
         * e = originalCar.getType().equals(typeSelected); if
         * (typeSelected.equals("Select")) e = true;
         * 
         * f = (originalCar.getPrice() >= minPrice) && (originalCar.getPrice() <
         * maxPrice); if (priceSelected.equals("Select")) f = true;
         * 
         * g = !tempCarList.contains(originalCar);
         * 
         * if (a && b && c && d && e && f && g) { tempCarList.add(originalCar);
         * } }
         */
    }
